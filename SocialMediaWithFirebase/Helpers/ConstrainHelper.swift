...
extension UIView {
    ...
    func anchorToVCEdege(type_self vc: UIViewController) {
        ...
        self.topAnchor.constraint(equalTo: vc.view.safeAreaLayoutGuide.topAnchor, constant: 0).isActive = true
        self.bottomAnchor.constraint(equalTo: vc.view.safeAreaLayoutGuide.bottomAnchor, constant: 0).isActive = true
